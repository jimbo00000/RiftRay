...
// @var title Xyptonjtroz
// @var author nimitz
// @var url https://www.shadertoy.com/view/4ts3z2

// @var vec3 ligt .5 .05 -.2 dir
uniform vec3 ligt; // = normalize( vec3(.5, .05, -.2) );
// @var vec3 ligt2 .5 -.1 -.2 dir
uniform vec3 ligt2; // = normalize( vec3(.5, -.1, -.2) );
