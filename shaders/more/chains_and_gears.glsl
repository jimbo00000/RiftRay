...
// @var Title Chains and Gears
// @var author P_Malin
// @var url https://www.shadertoy.com/view/Msl3Rn

// @var eyePos -2.1 2.5 -1.2
...
vec3 getSceneColor(in vec3 ro, in vec3 rd)
{
    ...
    return Tonemap(cScene * fExposure);
}
...
void main( void )
{
    ...
    gl_FragColor = vec4( getSceneColor(ray.vOrigin,ray.vDir), 1.0 );
}
#endif
