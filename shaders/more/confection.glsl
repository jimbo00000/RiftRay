// Unlimited Confectionary
// by fizzer

// @var title Unlimited Confectionary
// @var author fizzer
// @var url https://www.shadertoy.com/view/lsj3zy

// @var eyePos 0.0 2.75 0.0
...
vec3 getSceneColor( in vec3 ro, in vec3 rd )
{
	...
	float icing=1.0;//1.0-iMouse.x/iResolution.x*icing_factor;
...
void main()
{
	...
	tc=gl_FragCoord.xy/iResolution.xy*2.0-vec2(1.0);
